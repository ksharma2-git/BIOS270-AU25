...
What micromamba command can you use to list all created environments?

micromamba env list

What micromamba command can you use to list all packages installed in a specific environment?

For this example: micromamba list -n bioinfo_example
Generally: micromamba list -n <env_name>
...
Create an example python file in your $SCRATCH that prints "Hello World!" and execute the file with your singularity container. Can you run it? Why do you think this is the case?

Yes, I can run it. This is likely the case because the file in the Scratch directory show up inside the singularity container, so python in hte singularity container can run them.
